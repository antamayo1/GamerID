...
const SearchBar = ({value, onChange, handleSearch, onClearSearch}) => {
    return (
        <>
            <div className="w-80 items-center flex px-4 bg-slate-100 rounded-md">
                <input type="text" placeHolder="Game" className="w-full text-xs bg-transparent py-[11px] outline-none" value={value}
                onChange={onChange} />
